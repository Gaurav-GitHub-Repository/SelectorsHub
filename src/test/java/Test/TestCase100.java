...
import Pages.WindowHandle_Dahsboard;
...
public class TestCase100 {
	...
	static Logger log = Logger.getLogger(TestCase100.class.getName());
	...
	public void regression() throws InterruptedException, IOException
	{
		...
		WindowHandle_Dahsboard handle = new WindowHandle_Dahsboard(driver);
		handle.clickOnCheckoutLink();
		handle.clickOnTestCaseStudio();
		handle.switchToWindow();
		//handle.verifySwitchedWindow();
