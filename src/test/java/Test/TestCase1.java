...
import Pages.RegistrationForm_Dashboard;
...
public class TestCase1 {
	...
	@Test(priority=1)
	public void regression() throws InterruptedException, FileNotFoundException
	{
		Dashboard dashboard = new Dashboard(driver);	
		//dashboard.page();
		//dashboard.verifyPage();
		RegistrationForm_Dashboard form = new RegistrationForm_Dashboard(driver);
		form.enterUserEmail("gaurav@gmail.com");
		form.enterPassword("Gaurav");
		form.enterCompany("abc");
		form.enterMobileNumber("2603243312");
