...
public class TestCase107 {
	...
	static Logger log = Logger.getLogger(TestCase107.class.getName());
	...
	public void regression() throws InterruptedException, IOException
	{
		...
		RadioButton_Dashboard radiobutton = new RadioButton_Dashboard(driver);
		radiobutton.scroll();
		radiobutton.switchToFrame();
		radiobutton.radiobutton3();
		radiobutton.clickOnSubmitButton();
		//radiobutton.switchToFrame();
		radiobutton.verifySubmitResponse();
