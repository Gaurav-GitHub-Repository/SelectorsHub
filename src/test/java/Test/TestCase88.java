...
public class TestCase88 {
	...
	static Logger log = Logger.getLogger(TestCase88.class.getName());
	...
	public void regression() throws InterruptedException, IOException
	{
		...
		Checkbox_Dashboard checkbox = new Checkbox_Dashboard(driver);
		checkbox.clickOnCheckbox();
		checkbox.verifyCheckbox();
		checkbox.verifyTable();
		checkbox.verifyHeaderTable();
