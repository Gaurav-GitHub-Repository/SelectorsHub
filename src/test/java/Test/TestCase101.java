...
import Pages.WebTable_Dashbaord;
...
public class TestCase101 {
	...
	static Logger log = Logger.getLogger(TestCase101.class.getName());
	...
	public void regression() throws InterruptedException, IOException
	{
		...
		WebTable_Dashbaord webtable_dashboard = new WebTable_Dashbaord(driver);
		webtable_dashboard.scrollToSystemDistribution();
		webtable_dashboard.enterSearch2("windows");
		webtable_dashboard.countWindowsOS();
