...
public class TestCase98 {
	...
	static Logger log = Logger.getLogger(TestCase98.class.getName());
	...
	public void regression() throws InterruptedException, IOException
	{
		...
		Alert_Dashboard alert_dashboard = new Alert_Dashboard(driver);
		alert_dashboard.clickOnBottomSlide();
		alert_dashboard.verifyBottomSlide();
		alert_dashboard.closeBotton();
