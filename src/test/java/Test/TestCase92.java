...
import Pages.Alert_Dashboard;
import Pages.Dashboard;
import Pages.FileUpload_Dashboard;
...
public class TestCase92 {
		...
		static Logger log = Logger.getLogger(TestCase92.class.getName());
		...
		public void regression() throws InterruptedException, IOException
		{
			...
			FileUpload_Dashboard upload = new FileUpload_Dashboard(driver);
			upload.scroll();
			Alert_Dashboard alertdashboard = new Alert_Dashboard(driver);
			alertdashboard.clickOnAlertButton();
			alertdashboard.verifyAlert();
